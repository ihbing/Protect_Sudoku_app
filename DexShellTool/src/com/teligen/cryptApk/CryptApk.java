...
public class CryptApk {
	...
	public static void main(String[] args) {
		...
		try {
			File payloadSrcFile = new File("force/orgin.apk");   //需要加壳的程序
			System.out.println("apk size:"+payloadSrcFile.length());
			File unShellDexFile = new File("force/unshell.dex");	//解壳dex
